...
func DeleteTransaction(mongoClient *mongo.Client) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := webutil.Bind(r, &req); err != nil {
			...
			webutil.RenderWithStatusCode(
				...
				errors.Wrap(err, "transaction deletion failed").AddTag("id", req.ID),
			)
			...
			webutil.RenderWithStatusCode(
				...
				errors.New("too many transactions deleted").
