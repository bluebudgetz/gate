...
type (
	...
	PatchAccountData     struct{ GetAccountData }
...
func PatchAccount() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err := webutil.Bind(r, &req); err != nil {
			...
			PatchNode(w, r, patchAccountQuery, map[string]interface{}{"id": req.ID, "name": req.Body.Name, "parentId": req.Body.ParentID}, func(rec neo4j.Record) (interface{}, error) {
